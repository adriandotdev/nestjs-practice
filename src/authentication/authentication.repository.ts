...
export class AuthenticationRepository {
    ...
    SaveUser(data: CreateAccountDTO): Promise<ResultSetHeader> {
        ...
        return new Promise((resolve, reject) => {
            ...
            pool.query(QUERY, [data.username, data.password], (err, result: ResultSetHeader) => {
    ...
    SaveUserDetail(data: CreateAccountDTO, id: number) {
        ...
        return new Promise((resolve, reject) => {
            ...
            pool.query(QUERY, [id, data.given_name, data.last_name, data.date_of_birth], (err, result) => {
